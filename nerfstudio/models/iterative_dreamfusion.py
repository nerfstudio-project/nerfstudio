...
@dataclass
class DreamFusionIterativeModelConfig(ModelConfig):
    """DreamFusion model config"""

    _target: Type = field(default_factory=lambda: DreamFusionIterativeModel)
    ...
    taper_range: Tuple[int, int] = (0, 5000)
...
class DreamFusionIterativeModel(Model):
    ...
    config: DreamFusionIterativeModelConfig
