...
class GaussianPointcloud:
    ...
    def __init__(self, sh_degree : int, max_points : int = None):
    ...
    #     if self.max_points is not None and pcd.points.shape[0] > self.max_points:
    #         keep_indices = np.random.choice(pcd.points.shape[0], self.max_points, replace=False)
    #         pcd = BasicPointCloud(
    #             points = pcd.points[keep_indices], 
    #             colors = pcd.colors[keep_indices], 
    #             normals = pcd.normals[keep_indices]
    #         )
