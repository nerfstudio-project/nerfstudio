...
def components_from_spherical_harmonics(
    ...
    data_out = []
    data_out.append(0.28209479177387814 * ones)  # 1/(2*sqrt(pi))
    if levels > 1:
        data_out.append(-0.48860251190291987 * y)  # -sqrt(3)*y/(2*sqrt(pi))
        data_out.append(0.48860251190291987 * z)  # sqrt(3)*z/(2*sqrt(pi))
        data_out.append(-0.48860251190291987 * x)  # -sqrt(3)*x/(2*sqrt(pi))
    if levels > 2:
        data_out.append(1.0925484305920792 * xy)  # sqrt(15)*xy/(2*sqrt(pi))
        data_out.append(-1.0925484305920792 * yz)  # -sqrt(15)*yz/(2*sqrt(pi))
        data_out.append(0.94617469575755997 * z2 - 0.31539156525251999)  # sqrt(5)*(3*z2 - 1)/(4*sqrt(pi))
        data_out.append(-1.0925484305920792 * xz)  # -sqrt(15)*xz/(2*sqrt(pi))
        data_out.append(0.54627421529603959 * x2 - 0.54627421529603959 * y2)  # sqrt(15)*(x2 - y2)/(4*sqrt(pi))
    if levels > 3:
        data_out.append(0.59004358992664352 * y * (-3.0 * x2 + y2))  # sqrt(70)*y*(-3*x2 + y2)/(8*sqrt(pi))
        data_out.append(2.8906114426405538 * xy * z)  # sqrt(105)*xy*z/(2*sqrt(pi))
        data_out.append(0.45704579946446572 * y * (1.0 - 5.0 * z2))  # sqrt(42)*y*(1 - 5*z2)/(8*sqrt(pi))
        data_out.append(0.3731763325901154 * z * (5.0 * z2 - 3.0))  # sqrt(7)*z*(5*z2 - 3)/(4*sqrt(pi))
        data_out.append(0.45704579946446572 * x * (1.0 - 5.0 * z2))  # sqrt(42)*x*(1 - 5*z2)/(8*sqrt(pi))
        data_out.append(1.4453057213202769 * z * (x2 - y2))  # sqrt(105)*z*(x2 - y2)/(4*sqrt(pi))
        data_out.append(0.59004358992664352 * x * (-x2 + 3.0 * y2))  # sqrt(70)*x*(-x2 + 3*y2)/(8*sqrt(pi))
    if levels > 4:
        data_out.append(2.5033429417967046 * xy * (x2 - y2))  # 3*sqrt(35)*xy*(x2 - y2)/(4*sqrt(pi))
        data_out.append(1.7701307697799304 * yz * (-3.0 * x2 + y2))  # 3*sqrt(70)*yz*(-3*x2 + y2)/(8*sqrt(pi))
        data_out.append(0.94617469575756008 * xy * (7.0 * z2 - 1.0))  # 3*sqrt(5)*xy*(7*z2 - 1)/(4*sqrt(pi))
        data_out.append(0.66904654355728921 * yz * (3.0 - 7.0 * z2))  # 3*sqrt(10)*yz*(3 - 7*z2)/(8*sqrt(pi))
        data_out.append(
            -3.1735664074561294 * z2 + 3.7024941420321507 * z4 + 0.31735664074561293
        )  # 3*(-30*z2 + 35*z4 + 3)/(16*sqrt(pi))
        data_out.append(0.66904654355728921 * xz * (3.0 - 7.0 * z2))  # 3*sqrt(10)*xz*(3 - 7*z2)/(8*sqrt(pi))
        data_out.append(
            0.47308734787878004 * (x2 - y2) * (7.0 * z2 - 1.0)
        )  # 3*sqrt(5)*(x2 - y2)*(7*z2 - 1)/(8*sqrt(pi))
        data_out.append(1.7701307697799304 * xz * (-x2 + 3.0 * y2))  # 3*sqrt(70)*xz*(-x2 + 3*y2)/(8*sqrt(pi))
        data_out.append(
    ...
    if levels > 5:
        ...
        data_out.append(8.3026492595241645 * xy * z * (x2 - y2))  # 3*sqrt(385)*xy*z*(x2 - y2)/(4*sqrt(pi))
        data_out.append(
            -0.48923829943525038 * y * (3.0 * x2 - y2) * (9.0 * z2 - 1.0)
        )  # -sqrt(770)*y*(3*x2 - y2)*(9*z2 - 1)/(32*sqrt(pi))
        data_out.append(4.7935367849733241 * xy * z * (3.0 * z2 - 1.0))  # sqrt(1155)*xy*z*(3*z2 - 1)/(4*sqrt(pi))
        data_out.append(
    ...
    return torch.stack(data_out, dim=-1)
