...
from nerfstudio.configs.method_configs import base_methods
...
def eval_setup(
    ...
    config.pipeline.datamanager._target = base_methods[config.method_name].pipeline.datamanager._target
