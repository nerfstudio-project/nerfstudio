...
class ExperimentConfig(InstantiateConfig):
    ...
    """Relative path to save all checkpoints. Alias for --pipeline.datamanager.data"""
    ...
    def get_base_dir(self) -> Path:
        ...
        assert self.experiment_name is not None, "This shouldn't happen. Experiment name should be set."
