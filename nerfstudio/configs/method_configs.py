...
from nerfstudio.data.datamanagers.dreamfusionplus_datamanager import DreamFusionPlusDataManagerConfig
...
from nerfstudio.models.dreamfusionplus import DreamFusionPlusModelConfig
