...
from nerfstudio.data.pixel_samplers import PixelSampler, EquirectangularSampler
...
class VanillaDataManager(DataManager):  # pylint: disable=abstract-method
    ...
    def setup_train(self):
        ...
        self.train_pixel_sampler = EquirectangularSampler(self.config.train_num_rays_per_batch)
