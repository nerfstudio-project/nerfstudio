...
def get_src_from_pairs(
    ref_idx: int, all_imgs, pairs_srcs, neighbors_num=None, neighbors_shuffle=False
) -> Dict:
...
def get_image(image_filename, alpha_color=None) -> Float[Tensor, "image_height image_width num_channels"]:
