""" Data parser for replica datasets. """
...
class Replica(DataParser):
    ...
    def _generate_dataparser_outputs(self, split="train"):
        ...
        if self.config.include_semantics:
            semantic_fns = [self.config.data / Path(f"semantic/semantic_class_{idx}.png") for idx in range(0, 900, 4)]
            semantic_fns = [semantic_fns[i] for i in indices]
            ...
            semantics = Semantics(filenames=semantic_fns, classes=classes, colors=colors, mask_classes=["void"])
