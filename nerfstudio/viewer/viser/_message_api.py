...
class MessageApi(abc.ABC):
    ...
    def send_status_message(self, eval_res: str, vis_train_ratio: str, step: int):
        """Send status message
        ...
        """
        self._queue(_messages.StatusMessage(eval_res=eval_res, vis_train_ratio=vis_train_ratio, step=step))
