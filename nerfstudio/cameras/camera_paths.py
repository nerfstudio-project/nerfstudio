...
def get_interpolated_camera_path(cameras: Cameras, steps: int, adjust_speed: bool) -> Cameras:
    ...
    poses, Ks = get_interpolated_poses_many(poses, Ks, steps_per_transition=steps, adjust_speed=adjust_speed)
