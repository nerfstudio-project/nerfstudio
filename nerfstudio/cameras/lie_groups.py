...
def exp_map_SO3xR3(tangent_vector: Shaped[Tensor, "b 6"]) -> Shaped[Tensor, "b 3 4"]:  # pylint: disable=invalid-name
...
def exp_map_SE3(tangent_vector: Shaped[Tensor, "b 6"]) -> Shaped[Tensor, "b 3 4"]:  # pylint: disable=invalid-name
