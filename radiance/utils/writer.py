...
import radiance.utils.writer
from radiance.utils.decorators import check_main_thread, decorate_all
...
def setup_event_writers(config: DictConfig) -> None:
    ...
    for writer_type in logging_configs:
        writer_class = getattr(radiance.utils.writer, writer_type)
