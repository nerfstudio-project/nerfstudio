...
from radiance.nerf.field_modules.encoding import Encoding, Identity, NeRFEncoding
from radiance.nerf.field_modules.field_heads import DensityFieldHead, FieldHeadNames, RGBFieldHead, SemanticFieldHead
from radiance.nerf.field_modules.mlp import MLP
from radiance.nerf.fields.base import Field
from radiance.nerf.fields.nerf_field import NeRFField
from radiance.nerf.graph.vanilla_nerf import NeRFGraph
from radiance.nerf.renderers import SemanticRenderer
from radiance.structures.rays import PointSamples, RayBundle
...
class SemanticNerfGraph(NeRFGraph):
    ...
    def log_test_image_outputs(self, image_idx, step, batch, outputs):
        ...
        writer.put_image(name=f"image_idx_{image_idx}", image=semantic_labels_image, step=step, group="semantics")
