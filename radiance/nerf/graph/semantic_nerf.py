...
from radiance.nerf.field_modules.field_heads import FieldHeadNames, SemanticStuffHead
from radiance.nerf.field_modules.mlp import MLP
from radiance.nerf.graph.vanilla_nerf import NeRFField, NeRFGraph
from radiance.nerf.renderers import SemanticRenderer
from radiance.structures.rays import RayBundle, RaySamples
...
class SemanticNerfGraph(NeRFGraph):
    ...
    def log_test_image_outputs(self, image_idx, step, image, mask, outputs):
        ...
        writer.put_image(name="image_idx_{image_idx}", image=semantic_labels_image, step=step, group="semantics")
