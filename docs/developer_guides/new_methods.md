...
Examples are often the best way to learn, take a look at the [LERF](https://github.com/kerrj/lerf) repository for a good example of how to use nerfstudio in your projects. You can use the [nerfstudio-template](https://github.com/maturk/nerfstudio-template) repository as a minimal guide to register your new methods.
