...
pyRad |:metal:| provides a simple API that allows for a seamless and simplified end-to-end process of creating, training, and testing NeRFs.
...
It's as simple as plug and play with pyRad!
...
* **Tutorials**: a great place to start if you are new to pyRad. Contains a quick tour, installation, and an overview of the core structures that will allow you to get up and running with pyRad |:metal:|
