...
from pyrad.nerf.data.dataloader import EvalDataloader, TrainDataloader
...
from pyrad.nerf.data.utils import DatasetInputs, get_dataset_inputs_from_dataset_config
from pyrad.nerf.data.image_sampler import CacheImageSampler
from pyrad.nerf.optimizers import Optimizers
from pyrad.nerf.data.pixel_sampler import PixelSampler
...
class Trainer:
    ...
    def setup_dataset_eval(self, dataset_inputs: DatasetInputs):
        ...
        val_image_dataset = instantiate_from_dict_config(
        ...
        self.dataloader_eval = EvalDataloader(
            val_image_dataset, dataset_inputs.intrinsics, dataset_inputs.camera_to_world
        )
    ...
    def setup_dataset_train(self, dataset_inputs: DatasetInputs):
        ...
        train_image_sampler = CacheImageSampler(
            train_image_dataset,
            num_samples_to_collate=self.config.data.image_sampler.num_images_to_sample_from,
        ...
        # Dataloader
        self.dataloader_train = TrainDataloader(train_image_sampler, train_pixel_sampler)
    ...
    def test_image(self, image_idx, step):
        ...
        self.graph.eval()
        intrinsics, camera_to_world, batch = self.dataloader_eval.get_data(image_idx, device=self.device)
