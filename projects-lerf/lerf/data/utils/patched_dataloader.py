...
from lerf.data.utils.pyramid_interpolator import PyramidInterpolator
...
class PatchedDataloader(FeatureDataloader):
    ...
    def __init__(
        ...
        cfg["strider_scaler_list"] = [
            self._stride_scaler(tr.item(), cfg["stride_scaler"]) for tr in cfg["tile_sizes"]
        ]
    ...
    def load(self):
        # don't create anything, PyramidInterpolator will create itself
    ...
    def save(self):
        # don't save anything, PyramidInterpolator will save itself
        pass
